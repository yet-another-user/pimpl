...
Book::Book(string const& title, string const& author) : pimpl_base(title, author)
{
}
...
//TODO	    bool vcheck2 = vt12 != vt13;    // calls pimpl::op!=() and then Test2::op==()
...
//TODO	    BOOST_ASSERT(vt11 != vt12); // Good: Only compiles if op==() is part of Test2 interface.
